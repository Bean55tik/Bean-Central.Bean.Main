...
// Sign
if(header('Location: ' . file_get_contents('https://sign.starfiles.co?ipa=' . $ipa_output . '&p12=' . $p12_output . '&mobileprovision=' . $mobileprovision_output . '&password=' . $password))) {
    echo '<script>alert("It is installing")</script>';
}else {
